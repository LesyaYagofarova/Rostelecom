...
class RegistrationPageLocators():
    ...
    def should_be_field_address_correctness(self):
        ...
        input_address.clear()
        input_address.send_keys("+796693421  ")
    ...
    def should_be_check_telefone_sending_sms(self):
        ...
        input_password.clear()
        input_password.send_keys("saveGod77")
        input_password_confirm.clear()
        input_password_confirm.send_keys('saveGod77')
        button region_list.click()
        region_list.send_keys('Санкт-Петербург')
